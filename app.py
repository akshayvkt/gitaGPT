...
question=st.text_area("**How are you feeling? Ask a question or describe your situation below. Press Enter button once you're done typing**",'',height = 20,placeholder='Type your question here')
if st.button('Enter'):
